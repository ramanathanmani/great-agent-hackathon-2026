...
- [ ] T-009: 🟠 Assert backup language-ID thresholds (95/85/90) and latency budget (median ≤ 2 ms, p95 ≤ 10 ms over 80 calls) in `test/benchmark.test.mjs` (REQ-ENG-007, REQ-BEN-003, REQ-BEN-006)
